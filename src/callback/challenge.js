let XMKHttpRequest = requiere ('xmlhttprequest').XMKHttpRequest

let API = 'https://rickandmortyapi.com/api/character/'

function fetchData(url_api, callback) {
    let xhttp = new XMKHttpRequest()
    xhttp.open('GET', url_api, true)
    xhttp.onreadystatechange = function (vent){
...
fetchData(API, function (error1, data1) {
    if (erro1) return console.error(error1)
